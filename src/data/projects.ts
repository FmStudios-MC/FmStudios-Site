...
export const projects: Project[] = [
  ...
  },
  {
    ...
    subcategory: 'tech',
    status: 'discontinued',
    logo: 'https://media.forgecdn.net/avatars/thumbnails/858/859/64/64/638264340110882688.png',
    description:
      'The start of the Create F&M series',
    version: 'Forge 1.19.2',
    features: ['Create Mod', 'Create Add-ons'],
    screenshots: ['https://imgs.search.brave.com/CDiVJY5BvABKaiYpC1VPKQ9yxhHDA0V3BErStlto9uc/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/OW1pbmVjcmFmdC5u/ZXQvd3AtY29udGVu/dC91cGxvYWRzLzIw/MjIvMDcvQ3JlYXRl/LU1vZC0xLmpwZw'],
    downloadUrl: 'https://www.curseforge.com/minecraft/modpacks/create-f-m',
    downloads: '275',
